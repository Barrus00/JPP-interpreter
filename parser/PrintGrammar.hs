...
instance Print (AbsGrammar.Stmt' a) where
  prt i = \case
    ...
    AbsGrammar.Cond _ cndt -> prPrec i 0 (concatD [prt 0 cndt])
...
instance Print (AbsGrammar.Cndt' a) where
  prt i = \case
    AbsGrammar.Condit _ expr block cndt -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block, prt 2 cndt])
    AbsGrammar.CondElif _ expr block cndt -> prPrec i 2 (concatD [doc (showString "elif"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block, prt 2 cndt])
    AbsGrammar.CondElse _ block stmt -> prPrec i 2 (concatD [doc (showString "else"), prt 0 block, prt 0 stmt])
    AbsGrammar.CondStmt _ stmt -> prPrec i 2 (concatD [prt 0 stmt])
...
instance Print (AbsGrammar.Type' a) where
  prt i = \case
    ...
    AbsGrammar.Fun _ type_ types -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 types, doc (showString ")")])
