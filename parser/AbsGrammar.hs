...
data Stmt' a
    ...
    | InnerFun a (TopDef' a)
    | Ass a Ident (Expr' a)
    | TAss a [TItem' a] (Expr' a)
    | Incr a Ident
    | Decr a Ident
    | Ret a (Expr' a)
    | VRet a
    | Cond a (Expr' a) (Block' a)
    | CondElif a (Expr' a) (Block' a) [Elif' a] (Block' a)
...
data TItem' a = TItem a Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Elif = Elif' BNFC'Position
data Elif' a = Elif a (Expr' a) (Block' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
