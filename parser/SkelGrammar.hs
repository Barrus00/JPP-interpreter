...
transProgram x = case x of
  AbsGrammar.Program _ topdefs -> failure x
...
transArg x = case x of
  ...
  AbsGrammar.ArgRef _ type_ ident -> failure x
...
transStmt x = case x of
  ...
  AbsGrammar.InnerFun _ topdef -> failure x
  AbsGrammar.Ass _ ident expr -> failure x
  AbsGrammar.TAss _ titems expr -> failure x
  ...
  AbsGrammar.CondElif _ expr block1 elifs block2 -> failure x
  AbsGrammar.While _ expr stmt -> failure x
  AbsGrammar.For _ type_ ident expr1 expr2 stmt1 stmt2 -> failure x
...
transTItem :: Show a => AbsGrammar.TItem' a -> Result
transTItem x = case x of
  AbsGrammar.TItem _ ident -> failure x

transElif :: Show a => AbsGrammar.Elif' a -> Result
transElif x = case x of
  AbsGrammar.Elif _ expr block -> failure x
...
transType x = case x of
  ...
  AbsGrammar.Tuple _ types -> failure x
  AbsGrammar.Lambda _ args type_ -> failure x
  AbsGrammar.Fun _ type_ args -> failure x

transExpr :: Show a => AbsGrammar.Expr' a -> Result
transExpr x = case x of
  AbsGrammar.ETuple _ exprs -> failure x
  AbsGrammar.ELambdaApp _ expr exprs -> failure x
  ...
  AbsGrammar.ELambda _ args type_ block -> failure x
