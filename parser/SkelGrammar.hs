...
transStmt x = case x of
  ...
  AbsGrammar.Cond _ cndt -> failure x
...
transCndt :: Show a => AbsGrammar.Cndt' a -> Result
transCndt x = case x of
  AbsGrammar.Condit _ expr block cndt -> failure x
  AbsGrammar.CondElif _ expr block cndt -> failure x
  AbsGrammar.CondElse _ block stmt -> failure x
  AbsGrammar.CondStmt _ stmt -> failure x
...
transType x = case x of
  ...
  AbsGrammar.Fun _ type_ types -> failure x
